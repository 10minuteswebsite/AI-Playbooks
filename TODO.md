...
- **TODO-004 — Publish OpenCode-first operating guidance** — Published and merged in `main` via PR #11 (commit `83cd69c`); documentation, secret, handoff, JSON, and regression checks passed.
