...
PR #15 was human-approved and merged into `main`. [`skills/omnichannel-agent-architect/`](skills/omnichannel-agent-architect/) is now the single canonical shared Arquitecto Omnicanal skill source. Codex, Claude Code, and OpenCode installations use that version; product-local copies remain operational installations, not independent sources of truth.
