...
- `skills/omnichannel-agent-architect/`: canonical shared skill source merged by PR #15 for Codex, Claude Code, and OpenCode.
...
PR #15 established `skills/omnichannel-agent-architect/` as the single source shared by the three supported agent clients. Local or product-managed skill directories are replaceable operational copies and must not diverge into provider-specific Architect skills.
